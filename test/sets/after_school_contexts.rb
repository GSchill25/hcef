module Contexts
  module AfterSchoolContexts
      ...
      @as2 = FactoryGirl.create(:after_school, date: 1.day.ago, time_in: DateTime.now, time_out: DateTime.now, total_hours: 6, homework_time: 2, literacy_time: 2, technology_time: 1, reading_specialist_time: 1, goal: "finish homework", child: @child2, program: @program1)
